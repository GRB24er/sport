    ...
    <div className="vb-root">
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .vb-telegram{position:fixed;bottom:92px;right:28px;z-index:200;width:56px;height:56px;border-radius:50%;background:#0088cc;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(0,136,204,0.4);cursor:pointer;transition:all 0.2s;text-decoration:none}
        .vb-telegram:hover{transform:scale(1.1);box-shadow:0 6px 28px rgba(0,136,204,0.5)}
        ...
        @media(max-width:768px){
          ...
          .vb-telegram{bottom:78px!important;right:20px!important;width:50px!important;height:50px!important}
      ...
      <div style={{ position:"relative", zIndex:1 }}>
        ...
        <footer id="contact" className="vb-footer">
          <div className="vb-footer-grid">
            ...
            <div>
              <h4>Contact</h4>
              <a href="https://t.me/Bet_nyame08" target="_blank" rel="noopener noreferrer" style={{ fontSize:13, color:"#0088cc", marginBottom:10, lineHeight:1.7, display:"block", textDecoration:"none" }}>
                <span style={{ color:"#888" }}>Telegram</span><br/>Join Our Channel
              </a>
        ...
        {/* ═══ TELEGRAM ═══ */}
        <a href="https://t.me/Bet_nyame08" target="_blank" rel="noopener noreferrer" className="vb-telegram">
